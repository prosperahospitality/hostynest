...
export default function PropertyMasterDropDown ({ isOpen }) {
    ...
    return (
      ...
      >
        ...
        <DropdownItem className='text-foreground-600 hover:text-primary' startContent={<TbHotelService aria-hidden="true" className='size-6'/>} key="new"><Link href="/admin/propertymaster/imagetag">Image Tag</Link></DropdownItem>

...
// Redux actions
import {
    handleFormattedDateRange, handleSelectedRoom, handleUpdateBulkProperty,
    handleFormattedDateUpdateProp, handleFormattedDateUpdatePropCopy,
    handleSelectedRoomUpdateProperty, handleSelectedRadioUpdateProp,
    handleUpdatePropArray, handleUpdateRoomArray, handleFormattedDateUpdateRoom,
    handleSelectedRoomUpdateRoom, handleValueUpdateRoom, handleFormattedDateUpdateRate,
    handleSelectedRoomUpdateRate, handleValue3HourRate, handleValue6HourRate,
    handleValue12HourRate, handleValueBaseRate, handleValueChildRate,
    handleValueExtraPersonRate, handleUpdateRateArray, handleCheckPricePerGuest
} from "@/app/redux/slices/rateandinventorySlice";

// Components
import Daterangepickerreact from '@/_components/ui/DateRangePickerReact';
import QuickSoldModal from "@/_components/Partner/Rateandinventory/ManageInventory/QuickSoldModal";

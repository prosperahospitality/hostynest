...
import RIMainContTopBar from '@/_components/Partner/Rateandinventory/ManageInventory/RIMainContTopBar';
import EditModal from '@/_components/Partner/Rateandinventory/ManageInventory/EditModal';

import {
    removeQuickSoldFormattedDate,
    handleQuickSoldFormattedDate,
    handleFormattedDateUpdateProp,
    handleUpdatePropArray
...
const RIMainCont = () => {
    ...
    // const hotel_id = 64103436;
    const hotel_name = 'Taj Hotel';
